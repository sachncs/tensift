...
## 30 seconds to a factor

```bash
cargo install tensift-cli      # ~1 minute to compile
tensift 8633                   # p = 89, q = 97, verified
```

If you can run those two commands, the rest of this page is about what
just happened and how to take it further.
