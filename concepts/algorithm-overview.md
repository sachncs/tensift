...
<object type="image/svg+xml" data="{{ '/assets/img/pipeline.svg' | relative_url }}" style="width: 100%; height: auto; display: block; margin: 0 auto 1.5rem;" aria-label="The seven-stage tensift pipeline"></object>

*Click any stage on the [Stage docs](/stages/) page to read the detailed write-up.*
